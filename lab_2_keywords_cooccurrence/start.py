...
if __name__ == "__main__":
    ...
    freq = calculate_frequencies_for_content_words(candidate_phrases)
    word_degree = calculate_word_degrees(candidate_phrases, list(freq.keys()))
    ...
    RESULT = get_top_n(cumulative_score, 5, 4)
