...
if __name__ == "__main__":
    ...
    def lab_2(text: str, top_n: int, max_length: int) -> bool:
                    ...
                    if word_degrees:
                        ...
                        if word_scores:
                            ...
                            if cumulative_score_for_candidates:
                                ...
                                candidate_keyword_phrases_with_adjoining, cumulative_score_with_stop_words = \
    ...
    def lab_2_2(candidate_keyword_phrases: Optional[KeyPhrases],
        ...
        return candidate_keyword_phrases_with_adjoining, cumulative_score_with_stop_words
