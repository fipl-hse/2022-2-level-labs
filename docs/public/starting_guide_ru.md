...
6. [Добавить менторов в коллабораторы](#adding-collaborators)
7. [Клонировать форк репозитория для локальной работы](#cloning-fork)
8. [Создать проект в среде разработки PyCharm](#creating-project-in-pycharm)
9. [Изменить исходный код и отправить изменения в удалённый форк](#working-pipeline)
10. [Создать Pull Request](#creating-pull-request)
11. [Продолжить работу](#continue-working)
