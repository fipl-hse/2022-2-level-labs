...
**Важно №2**: критерий разделения текста на предложения: знак препинания (`.!?`), за которым следуют пробел и заглавная буква.
...
Создайте пользовательское исключение с именем `NoRelevantTextsException`. Что такое пользовательские исключения и как их создавать, вы можете
