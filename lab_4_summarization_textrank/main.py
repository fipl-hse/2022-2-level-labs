...
def type_check(check_object: Any, object_type: Union[Type, tuple[Type, ...]], token_type: Optional[Type],
               value_type: Optional[Type], can_be_empty: bool = True) -> None:
    """
...
class Sentence:
    ...
    def __init__(self, text: str, position: int) -> None:
        ...
        """
        type_check(text, str, None, None)
        type_check(position, int, None, None)
        self._text = text
    ...
    def set_preprocessed(self, preprocessed_sentence: PreprocessedSentence) -> None:
        ...
        :return: None
        """
        type_check(preprocessed_sentence, tuple, str, None)
    ...
    def set_encoded(self, encoded_sentence: EncodedSentence) -> None:
        ...
        :return: None
        """
        type_check(encoded_sentence, tuple, int, None)
...
class SentencePreprocessor(TextPreprocessor):
    ...
    def __init__(self, stop_words: tuple[str, ...], punctuation: tuple[str, ...]) -> None:
        ...
        Constructs all the necessary attributes
        """
        type_check(stop_words, tuple, str, None)
        type_check(punctuation, tuple, str, None)
    ...
    def _preprocess_sentences(self, sentences: tuple[Sentence, ...]) -> None:
        ...
        :return:
        """
        type_check(sentences, tuple, Sentence, None)
...
class SentenceEncoder(TextEncoder):
    ...
    def _learn_indices(self, tokens: tuple[str, ...]) -> None:
        ...
        :return:
        """
        type_check(tokens, tuple, str, None)
...
def calculate_similarity(sequence: Union[list, tuple], other_sequence: Union[list, tuple]) -> float:
    ...
    """
    type_check(sequence, (list, tuple), None, None)
    type_check(other_sequence, (list, tuple), None, None)
...
class SimilarityMatrix:
    ...
    def calculate_inout_score(self, vertex: Sentence) -> int:
        ...
        :return:
        """
        type_check(vertex, Sentence, None, None)
    ...
    def add_edge(self, vertex1: Sentence, vertex2: Sentence) -> None:
        ...
        :return:
        """
        type_check(vertex1, Sentence, None, None)
        type_check(vertex2, Sentence, None, None)
        if vertex1 == vertex2:
            raise ValueError
    ...
    def get_similarity_score(self, sentence: Sentence, other_sentence: Sentence) -> float:
        ...
        """
        type_check(sentence, Sentence, None, None)
        type_check(other_sentence, Sentence, None, None)
    ...
    def fill_from_sentences(self, sentences: tuple[Sentence, ...]) -> None:
        ...
        :return:
        """
        type_check(sentences, tuple, Sentence, None, False)
...
class TextRankSummarizer:
    ...
    def __init__(self, graph: SimilarityMatrix) -> None:
        ...
        """
        type_check(graph, SimilarityMatrix, None, None)
        self._graph = graph
    ...
    def update_vertex_score(
        ...
        """
        type_check(vertex, Sentence, None, None)
        type_check(incidental_vertices, list, Sentence, None)
    ...
    def get_top_sentences(self, n_sentences: int) -> tuple[Sentence, ...]:
        ...
        :return: a sequence of sentences
        """
        type_check(n_sentences, int, None, None)
...
class Buddy:
    ...
    def __init__(
        ...
        """
        type_check(paths_to_texts, list, str, None)
        type_check(stop_words, tuple, str, None)
        type_check(punctuation, tuple, str, None)
    ...
    def add_text_to_database(self, path_to_text: str) -> None:
        ...
        :return:
        """
        type_check(path_to_text, str, None, None)
    ...
    def _find_texts_close_to_keywords(self, keywords: tuple[str, ...], n_texts: int) -> tuple[str, ...]:
        ...
        """
        type_check(keywords, tuple, str, None)
        type_check(n_texts, int, None, None)
    ...
    def reply(self, query: str, n_summaries: int = 3) -> str:
        ...
        type_check(n_summaries, int, None, None)
