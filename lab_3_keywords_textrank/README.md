...
![](./task_description_images/graph.jpeg)
...
![](./task_description_images/directed_undirected_graph.jpeg)
<sub><sup>[источник картинки](https://medium.com/swlh/data-structures-graphs-50a8a032db03)</sub></sup>
...
![](./task_description_images/weighted_graph.jpeg)
<sub><sup>[источник картинки](https://medium.com/swlh/data-structures-graphs-50a8a032db03)</sub></sup>
...
![](./task_description_images/custom_graph.jpg)
...
Однако в реализации этого метода допущено 2 ошибки. Найдите и исправьте их, иначе выделить ключевые слова не удастся.
