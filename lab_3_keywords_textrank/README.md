...
В случае, если несколько вершин имеют один и тот же вес, необходимо учитывать значение самой вершины: вершины с меньшим значением идут впереди вершин с большим значением. Рассмотрим пример. 
